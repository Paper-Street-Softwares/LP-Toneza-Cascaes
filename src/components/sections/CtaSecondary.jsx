          ...
          <SectionWrapper className="">
            ...
            <div className="relative flex w-full justify-center text-center pb-[64px] desktop1:pb-0">
              ...
              <img
                ...
                className="absolute w-20 bottom-[-15%] left-1/2 transform -translate-x-1/2 phone2:bottom-[-20%] tablet1:bottom-[-20%] desktop1:bottom-[-65%] desktop1:left-[66%] desktop1:translate-x-0
             desktop2:bottom-[-65%] desktop2:left-[62%] "
              />
            </div>
          </SectionWrapper>
        </SectionArea>
